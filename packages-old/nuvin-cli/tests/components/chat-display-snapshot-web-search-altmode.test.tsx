...
describe('ChatDisplay - web_search tool call snapshot altMode (running → done)', () => {
  const userMessage: MessageLineType = {
    id: 'msg-user',
    type: 'user',
    content: 'Search for React hooks best practices',
  };
      ...
      toolCalls: [
        {
          ...
          function: {
            name: 'web_search',
            arguments: JSON.stringify({ query: 'React hooks best practices' }),
          },
        },
      ],
    },
