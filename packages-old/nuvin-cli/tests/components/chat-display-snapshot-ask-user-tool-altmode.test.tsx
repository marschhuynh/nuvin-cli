...
describe('ChatDisplay - ask_user_tool tool call snapshot altMode (running → done)', () => {
  ...
  it('snapshot: running state (no result yet)', () => {
    // ask_user_tool has hideUntilComplete: true — the tool call is hidden in running state
  ...
  it('snapshot: done state (result appended)', () => {
    ...
    // Append tool result → hideUntilComplete lifts, answer is now visible
    rerender(
