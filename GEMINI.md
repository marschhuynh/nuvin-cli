# GEMINI.md — Working With This Repository

This guide helps human and automated coding agents, specifically Google's Gemini, to work effectively in this monorepo. It summarizes how the project is organized, how to build and test each part, coding conventions, and operational tips.
...
- Dev with hot reload: `cd nuvin-ui && wails3 task dev`
- Build binaries: `cd nuvin-ui && wails3 task build`
- Frontend only:
...
## Common Gemini Tasks & Pointers

Gemini can assist with a variety of development tasks in this project. Here are some examples:
...
- **Writing tests:**
  - Gemini can write unit tests for React components, Zustand stores, and Go services.
  - Provide the code to be tested and ask Gemini to generate tests for it.
- **Refactoring code:**
  - Gemini can refactor code to improve readability, performance, or to adhere to the project's coding conventions.
- **Answering questions about the codebase:**
  - Gemini can help you understand the codebase by answering questions about specific files or functions.

## Deployment & Packaging

- Desktop app: `wails build` to produce binaries (see `nuvin-ui/wails.json`)
- Packaging: `wails3 task package:archive` to create installers (per-platform)
- Server:
