export function getLineInfo(value, offset) {
...
export function moveCursorVertically(value, offset, direction) {
    if (!value.includes("\n")) {
        return null;
    }
...
export function moveCursorVisually(value, offset, direction, wrapWidth) {
    if (wrapWidth <= 0) {
...
export function findNextWordEnd(text, start) {
    let i = start;
...
export function clampOffset(valueLength, offset, mode) {
    if (valueLength <= 0) {
        return 0;
    }
    if (mode === "normal") {
...
//# sourceMappingURL=textNavigation.js.map