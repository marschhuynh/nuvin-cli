...
import type { Orchestrator } from '@nuvin/nuvin-core';
...
describe('/swap command - event handling', () => {
  ...
  it('should emit agent:swapped event with correct structure', async () => {
    ...
    vi.spyOn(orchestratorManager, 'getOrchestrator').mockReturnValue(mockOrchestrator as Partial<Orchestrator>);
...
describe('Memory preservation during swap', () => {
  ...
  it('should verify swapToAgent accesses memory and conversation context', () => {
    ...
    const getOrchestratorSpy = vi
      ...
      .mockReturnValue(mockOrchestrator as Partial<Orchestrator>);
    const getConversationContextSpy = vi
      .spyOn(orchestratorManager, 'getConversationContext')
      .mockReturnValue(mockContext as never);
    const getMemorySpy = vi.spyOn(orchestratorManager, 'getMemory').mockReturnValue(mockMemory as never);
