...
describe('ChatDisplay - grep_tool tool call snapshot altMode (running → done)', () => {
  const userMessage: MessageLineType = {
    id: 'msg-user',
    type: 'user',
    content: 'Search for TODO comments in the source',
  };
      ...
      toolCalls: [
        {
          ...
          function: {
            name: 'grep_tool',
            arguments: JSON.stringify({ pattern: 'TODO', path: 'src', include: '*.ts' }),
          },
        },
      ],
    },
  ...
  const toolResultMessage: MessageLineType = {
    ...
    metadata: {
      toolResult: {
        ...
        status: 'success',
        type: 'text',
        result: 'src/utils.ts:10: // TODO: refactor\nsrc/app.ts:25: // TODO: optimize',
        metadata: { matchCount: 2, fileCount: 2 },
      },
      duration: 42,
    },
  };
