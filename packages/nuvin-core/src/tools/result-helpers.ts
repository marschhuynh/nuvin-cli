...
>(result: T, metadata?: M): { status: 'success'; type: 'json'; result: T; metadata?: M } {
  return { status: 'success', type: 'json', result, metadata };
}

export function err(result: string, metadata?: Record<string, unknown>, errorReason?: ErrorReason): ExecResultError {
