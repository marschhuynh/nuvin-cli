...
export function transformToolsToResponsesFormat(tools?: CompletionParams['tools']): ResponsesTool[] | undefined {
...
export function transformFromResponsesOutput(response: ResponsesApiResponse): CompletionResult {
  let content = '';
...
export function buildResponsesRequestBody(params: ResponseParams, stream: boolean = false): ResponsesApiRequest {
