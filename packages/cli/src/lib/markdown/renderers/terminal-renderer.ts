...
import { COLON_REPLACER, insertEmojis, undoColon } from "./emoji-processor.js";
import { BULLET_POINT, fixNestedLists, formatList, indentLines } from "./list-renderer.js";
import type {
  HighlightOptions,
...
import { createTable, TABLE_CELL_SPLIT, TABLE_ROW_WRAP } from "./table-renderer.js";
import { hr, indent, reflowText, section } from "./text-reflow.js";
import {
  compose,
  fixHardReturn,
  identity,
...
class Renderer {
  ...
  code(
    ...
    return section(
      indent(
        this.tab,
        highlight(code, lang, this.o.code, this.o.reflowText, this.highlightOptions),
      ),
    );
  }
